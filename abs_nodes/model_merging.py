...
"""
    A rewrite of the original ComfyUI nodes for merging models and saving checkpoints in a more controlled manner.
"""



class AbsModelMergeSimple:
    @classmethod
    def INPUT_TYPES(s):
    ...
    CATEGORY = "clip_suite/unet_merging"
...
class AbsCLIPMergeSimple:
    ...
    CATEGORY = "clip_suite/clip_merging"
...
def save_checkpoint(model, clip=None, vae=None, clip_vision=None, filename_prefix=None, output_dir=None, prompt=None, extra_pnginfo=None):
    ...
    elif isinstance(model.model, comfy.model_base.SD35_m_unchained):
        metadata["modelspec.architecture"] = "stable-diffusion-v35-medium"
    else:
...
class AbsVAESave:
    ...
    CATEGORY = "clip_suite/vae_merging"
...
NODE_CLASS_MAPPINGS = {
    "AbsModelMergeSimple": AbsModelMergeSimple,
    "AbsModelMergeBlocks": AbsModelMergeBlocks,
    "AbsModelMergeSubtract": AbsModelSubtract,
    "AbsModelMergeAdd": AbsModelAdd,
    "AbsCheckpointSave": AbsCheckpointSave,
    "AbsCLIPMergeSimple": AbsCLIPMergeSimple,
    "AbsCLIPMergeSubtract": AbsCLIPSubtract,
    "AbsCLIPMergeAdd": AbsCLIPAdd,
    "AbsCLIPSave": AbsCLIPSave,
    "AbsVAESave": AbsVAESave,
    "AbsModelSave": AbsModelSave,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "AbsCheckpointSave": "Save Checkpoint",
}
